...
import com.ssabae.demo.accounts.AccountAdapter;
import com.ssabae.demo.accounts.CurrentUser;
import com.ssabae.demo.common.ErrorsResource;
...
public class EventController {
    ...
    @PutMapping("/{id}")
    private ResponseEntity updateEvent(@PathVariable Integer id,
