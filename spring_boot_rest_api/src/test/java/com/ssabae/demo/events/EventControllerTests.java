...
import com.ssabae.demo.accounts.AccountRepository;
        ...
        mockMvc.perform(post("/api/events/")
                ...
                .andDo(document("create-event",
                        links(
                                ...
                                linkWithRel("profile").description("profile to update event")
                        ),
                        requestHeaders(
                        ...
                        relaxedResponseFields(
                                ...
                                fieldWithPath("_links.profile.href").description("profile to update event")
...
//                .andExpect(jsonPath("_link.profile").exists())
    ...
    private Account createAccount() {
        Account ssabae = Account.builder()
                ...
                .build();
        return this.accountService.saveAccount(ssabae);
    }
    ...
    public void getEvent_Empty() throws Exception {

        // When & Then
        this.mockMvc.perform(get("/api/events/{id}", 123456))
